...
def main():
    ...
    if args.data == "us_census":
        ...
        nX_tr, nX_va, nX_te, w_tr, w_va, w_te, values_tr, values_va, values_te, cost_tr, cost_va, cost_te, i_tr, i_va, i_te = \
            processing_data2(user_list_file, coupon_list_file, detail_file)
        input_dim = 4
        number_of_hidden = 32
        lmda = 5e-8
        pb_epochs = 2000
    ...
    # D_aucc['duality rlearner'] = aucc_drl
    ...
    ctpm_model = CTPM(D_dim=input_dim, num_hidden=number_of_hidden, temp=0, p_quantile=0, dropout_rate=0.0)
