...
# with open('ponpare_data.pkl', 'rb') as f:
#     data = pkl.load(f)
#     nX_tr = data['nX_tr']
#     nX_va = data['nX_va']     
#     nX_te = data['nX_te']
...
#     w_va = data['w_va']
#     w_te = data['w_te']
#     values_tr = data['values_tr']
#     values_va = data['values_va']
#     values_te = data['values_te']
#     cost_tr = data['negcost_tr']
#     cost_va = data['negcost_va']
#     cost_te = data['negcost_te']
#     i_tr = data['i_tr']
#     i_va = data['i_va']
#     i_te = data['i_te']
...
combined_scores = np.zeros_like(w_va, dtype=np.float32)
combined_scores[val_treat_index] = h_tre_rnkscore_val.detach().p().squeeze()
combined_scores[val_untreat_index] = h_unt_rnkscore_val.detach().numpy().squeeze()
